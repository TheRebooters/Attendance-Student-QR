...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
    ...
    <a class="navbar-brand mr-1" href="home.php"><img src="../images/camera-svgrepo.svg" class="image image-responsive" height="45" width="45"> Attendify</a>
...
?>
      ...
      <footer class="sticky-footer">
        <div class="container my-auto">
          ...
          <span>Copyright © Attendify 2023. Made with <i class="fas fa-heart text-danger"></i> by Students at <a href="http://psau.edu.ph">Pampanga State Agricultural University</a>.</span>
          </div>
        </div>
      </footer>
